class Solution:
    def orderedSearch(self, nums: List[int], l, r, target: int):
        ...
        if l<= r:
            ...
            if nums[mid] == target:
                ...
                return self.orderedSearch(nums, mid+1, r, target)
            else:
                return self.orderedSearch(nums, l, mid-1, target)
        else:
            return -1
